 ...
 */
public class StreamingDataToKafka extends Thread{
    ...
    public StreamingDataToKafka(String topic) {
        this.topic=topic;
        Properties properties = new Properties();
        properties.put("metadata.broker.list","master:9092,worker1:9092,worker2:9092");
    ...
    public void run() {
        while (true){
            String message = null;//封装消息
            producerForKafka.send(new KeyedMessage<Integer, String>(topic,message));
        }
    }
